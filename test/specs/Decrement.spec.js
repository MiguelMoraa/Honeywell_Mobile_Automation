...
import { DECREMENT_TEST } from '../../Data/Headers'
dotenv.config()
...
describe('Data Manipulation', () => {
    ...
    it('VOSMB-2937 VIO - Decrement Increment Test', async () => {
        for (let i = 0; i < DECREMENT_TEST.length; i++) {
            await expect($(CorePage.header)).toHaveText(DECREMENT_TEST[i])
