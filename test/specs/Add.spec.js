...
import { ADD_TEST } from '../../Data/Headers'
dotenv.config()
...
describe('Data Manipulation', () => {
    ...
    it('VOSMB-2933 VIO - Addition Test', async () => {
        for (let i = 0; i < ADD_TEST.length; i++) {
            await expect($(CorePage.header)).toHaveText(ADD_TEST[i])
