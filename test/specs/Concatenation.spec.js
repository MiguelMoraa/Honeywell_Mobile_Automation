...
import { CONCATENATION_TEST } from '../../Data/Headers'
dotenv.config()
...
describe('Data Manipulation', () => {
    ...
    it('VOSMB-2938 VIO - Concatenation Test', async () => {
        for (let i = 0; i < CONCATENATION_TEST.length; i++) {
            await expect($(CorePage.header)).toHaveText(CONCATENATION_TEST[i])
