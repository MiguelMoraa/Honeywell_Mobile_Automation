...
import { DIVISION_TEST } from '../../Data/Headers'
dotenv.config()
...
describe('Data Manipulation', () => {
    ...
    it('VOSMB-2936 VIO - Division Test', async () => {
        for (let i = 0; i < DIVISION_TEST.length; i++) {
            await expect($(CorePage.header)).toHaveText(DIVISION_TEST[i])
