...
import { SUBSTRACTION_TEST } from '../../Data/Headers'
dotenv.config()
...
describe('Data Manipulation', () => {
    ...
    it('VOSMB-2934 VIO - Subtraction Test', async () => {
        for (let i = 0; i < SUBSTRACTION_TEST.length; i++) {
            await expect($(CorePage.header)).toHaveText(SUBSTRACTION_TEST[i])
